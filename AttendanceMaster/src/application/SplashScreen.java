...
import application.SplashScreen.InitCompletionHandler;
...
//		file.createNewFile();
      ...
      mainStage.getIcons().add(new Image(ResourceLoader.load("/images/attendanceLogo1.png")));
...
//			Process p=Runtime.getRuntime().exec("cmd /c C://xampp//xampp-control.exe");
//			Process process2= Runtime.getRuntime().exec("cmd /c C://xampp//mysql_start.bat");
